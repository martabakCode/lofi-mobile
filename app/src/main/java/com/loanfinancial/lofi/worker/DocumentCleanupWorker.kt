...
@HiltWorker
class DocumentCleanupWorker @AssistedInject constructor(
    ...
    companion object {
        ...
        fun schedulePeriodic(context: Context) {
            val workRequest = PeriodicWorkRequestBuilder<DocumentCleanupWorker>(
    ...
    override suspend fun doWork(): Result {
        ...
        val oldCompletedUploads = pendingUploadDao.getCompletedUploadsOlderThan(
