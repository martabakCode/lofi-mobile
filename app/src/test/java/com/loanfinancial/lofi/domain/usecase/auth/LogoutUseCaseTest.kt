...
class LogoutUseCaseTest {
    ...
    @Test
    fun `invoke should clear local data and call logout when userId exists`() = runTest {
        // Arrange
        val userId = "user_123"
    ...
    @Test
    fun `invoke should not clear local data but call logout when userId is null`() = runTest {
        // Arrange
        val expectedResponse = LogoutResponse(message = "Logged out successfully")
