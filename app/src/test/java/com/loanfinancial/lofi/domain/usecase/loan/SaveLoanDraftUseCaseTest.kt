...
class SaveLoanDraftUseCaseTest {
    ...
    @Test
    fun `invoke should create new draft successfully`() = runTest {
        // Arrange
    ...
    @Test
    fun `invoke should update existing draft`() = runTest {
        // Arrange
    ...
    @Test
    fun `saveOrUpdateBasicInfo should update existing draft when draftId provided`() = runTest {
        // Arrange
        coEvery { 
        ...
        // Act
        val result = useCase.saveOrUpdateBasicInfo(
            draftId = "draft_123",
            amount = 5000000,
            tenor = 12,
            purpose = "Business",
    ...
    @Test
    fun `saveOrUpdateBasicInfo should create new draft when no draftId`() = runTest {
        // Arrange
    ...
    @Test
    fun `saveOrUpdateBasicInfo should reuse existing active draft`() = runTest {
        // Arrange
    ...
    @Test
    fun `updateEmploymentInfo should update repository and step`() = runTest {
        // Arrange
        coEvery { 
        ...
        // Act
        val result = useCase.updateEmploymentInfo(
            draftId = "draft_123",
            jobType = "Permanent",
    ...
    @Test
    fun `updateEmergencyContact should update repository and step`() = runTest {
        // Arrange
        ...
        // Act
        val result = useCase.updateEmergencyContact(
            draftId = "draft_123",
    ...
    @Test
    fun `updateBankInfo should update repository and step`() = runTest {
        // Arrange
        ...
        // Act
        val result = useCase.updateBankInfo(
            draftId = "draft_123",
            bankName = "BCA",
            bankBranch = "Jakarta",
    ...
    @Test
    fun `updateDocumentPaths should call repository`() = runTest {
        // Arrange
        val documentPaths = mapOf(
