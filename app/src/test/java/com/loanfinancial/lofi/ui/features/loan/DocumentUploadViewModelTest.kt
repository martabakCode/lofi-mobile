...
class DocumentUploadViewModelTest {
    ...
    @Test
    fun `observeUploadStatus should update state from repository`() = runTest {
        // Arrange
        val uploads = listOf(
    ...
    @Test
    fun `onDocumentSelected should update state and queue upload`() = runTest {
        // Arrange
    ...
    @Test
    fun `onDocumentSelected should handle all required document types`() = runTest {
        // Arrange
    ...
    @Test
    fun `onRetryUpload should re-queue failed upload`() = runTest {
        // Arrange
        val filePath = "/path/to/ktp.jpg"
    ...
    @Test
    fun `createTempFileUri should delegate to cameraManager`() = runTest {
        // Arrange
    ...
    @Test
    fun `isAllUploaded should be true when all documents completed`() = runTest {
        // Arrange
        val uploads = listOf(
            createUploadEntity(DocumentType.KTP.name, DocumentUploadStatus.COMPLETED),
    ...
    @Test
    fun `isAllUploaded should be false when some documents pending`() = runTest {
        // Arrange
        val uploads = listOf(
            createUploadEntity(DocumentType.KTP.name, DocumentUploadStatus.COMPLETED),
    ...
    @Test
    fun `should handle upload error state`() = runTest {
        // Arrange
        val uploads = listOf(
            createUploadEntity(
