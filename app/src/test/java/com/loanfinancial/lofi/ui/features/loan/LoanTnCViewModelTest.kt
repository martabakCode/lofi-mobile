...
class LoanTnCViewModelTest {
    ...
    @Test
    fun `onSubmitClicked should show error when form data is null`() =
        runTest {
            // Arrange
            viewModel.onAgreementCheckedChange(true)
    ...
    fun `onSubmitClicked should fallback to offline on network error`() =
        runTest {
            ...
            coEvery {
                ...
                flowOf(
                    com.loanfinancial.lofi.core.util.Resource
                        .Success(user),
                )
    ...
    @Test
    fun `onDismissError should clear error message`() =
        runTest {
    ...
    @Test
    fun `onDismissSuccess should reset state`() =
        runTest {
            // Arrange
            viewModel.setLoanFormData(createLoanFormData())
            viewModel.onAgreementCheckedChange(true)
    ...
    private fun createLoanFormData() =
        LoanFormData(
            amount = "5000000",
            tenor = "12",
            purpose = "Business",
