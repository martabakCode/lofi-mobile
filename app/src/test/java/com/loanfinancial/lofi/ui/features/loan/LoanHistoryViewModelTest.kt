...
class LoanHistoryViewModelTest {
    ...
    @Test
    fun `loadHistory should update state with loans`() = runTest {
        // Arrange
        val loans = listOf(
    ...
    @Test
    fun `loadHistory should include pending submissions`() = runTest {
        // Arrange
    ...
    @Test
    fun `loadHistory should handle error state`() = runTest {
        // Arrange
        every { getMyLoansUseCase(0, 10, any()) } returns 
    ...
    @Test
    fun `loadMore should increment page and append loans`() = runTest {
        // Arrange
    ...
    @Test
    fun `refresh should reset page and reload`() = runTest {
        // Arrange
    ...
    @Test
    fun `should set hasMore to false when no more items`() = runTest {
        // Arrange
        val loans = listOf(createLoan("loan_1", "SUBMITTED"))
    ...
    private fun createPendingSubmission(id: String, status: PendingSubmissionStatus) = 
