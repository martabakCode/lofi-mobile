...
class ApplyLoanViewModelTest {
    ...
    @Test
    fun `location capture error should show error state`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `next step should advance current step`() =
        runTest {
    ...
    @Test
    fun `previous step should go back`() =
        runTest {
    ...
    @Test
    fun `document removal should remove from state`() =
        runTest {
