...
class UserRepositoryImplTest {
    ...
    fun `getUserProfile should return user data on success`() =
        runTest {
            ...
            coEvery { userApi.getUserProfile() } returns
                Response.success(
    ...
    @Test
    fun `getUserProfile should return error on failure`() =
        runTest {
            // Arrange
            coEvery { userApi.getUserProfile() } returns
                Response.error(
    ...
    @Test
    fun `updateProfile should return success on valid data`() =
        runTest {
            // Arrange
            val request =
                com.loanfinancial.lofi.data.model.dto.UserUpdateRequest(
    ...
    @Test
    fun `updateProfile should return error on failure`() =
        runTest {
            // Arrange
            val request =
                com.loanfinancial.lofi.data.model.dto.UserUpdateRequest(
    ...
    @Test
    fun `uploadProfilePicture should return success`() =
        runTest {
            // Arrange
            val filePath = "/path/to/photo.jpg"
            coEvery { userApi.uploadProfilePicture(any()) } returns
                Response.success(
                    com.loanfinancial.lofi.data.model.dto.UserUpdateResponse(
                        success = true,
    ...
    @Test
    fun `getCachedUser should return user from dao`() =
        runTest {
            // Arrange
            val userEntity =
                com.loanfinancial.lofi.data.model.entity.UserEntity(
                    id = "user_123",
                    fullName = "Test User",
                    username = "testuser",
                    email = "test@test.com",
    ...
    @Test
    fun `saveProfileDraft should call dao`() =
        runTest {
            // Arrange
            val draft =
                com.loanfinancial.lofi.data.model.entity.ProfileDraftEntity(
                    userId = "user_123",
                    draftData = "{}",
                    updatedAt = System.currentTimeMillis(),
                )
    ...
    @Test
    fun `getProfileDraft should return draft from dao`() =
        runTest {
            // Arrange
            val draft =
                com.loanfinancial.lofi.data.model.entity.ProfileDraftEntity(
    ...
    @Test
    fun `clearProfileDraft should call dao`() =
        runTest {
            // Arrange
    ...
    @Test
    fun `getUser should return user from dao`() =
        runTest {
            // Arrange
            val userEntity =
                com.loanfinancial.lofi.data.model.entity.UserEntity(
