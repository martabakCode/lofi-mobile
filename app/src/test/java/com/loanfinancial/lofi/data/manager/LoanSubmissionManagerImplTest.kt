...
class LoanSubmissionManagerImplTest {
    ...
    @Test
    fun `submitLoanOffline should create pending submission successfully`() = runTest {
        // Arrange
    ...
    @Test
    fun `submitLoanOffline should fail when user not logged in`() = runTest {
        // Arrange
        val loanData = createLoanSubmissionData()
    ...
    @Test
    fun `getPendingSubmissions should return list of pending submissions`() = runTest {
        // Arrange
    ...
    @Test
    fun `getPendingSubmissions should return empty list when user not logged in`() = runTest {
        // Arrange
        coEvery { dataStoreManager.getUserId() } returns null
    ...
    @Test
    fun `retrySubmission should update status and schedule worker`() = runTest {
        // Arrange
        coEvery { 
    ...
    @Test
    fun `cancelSubmission should cancel pending submission`() = runTest {
        // Arrange
    ...
    @Test
    fun `triggerPendingSubmissions should reset failed submissions`() = runTest {
        // Arrange
    ...
    private fun createLoanSubmissionData() = LoanSubmissionData(
    ...
    private fun createPendingEntity() = PendingLoanSubmissionEntity(
        loanId = "test_loan_id",
        userId = "user_123",
        customerName = "Test Customer",
        productCode = "CASH_LOAN",
