...
class LoanDraftRepositoryImplTest {
    ...
    @Test
    fun `saveDraft should create new draft when id is empty`() = runTest {
        // Arrange
    ...
    @Test
    fun `saveDraft should update existing draft when id provided`() = runTest {
        // Arrange
    ...
    @Test
    fun `getDraftById should return draft when found`() = runTest {
        // Arrange
    ...
    @Test
    fun `getDraftById should return null when not found`() = runTest {
        // Arrange
    ...
    @Test
    fun `getAllActiveDrafts should return list of drafts`() = runTest {
        // Arrange
        val entities = listOf(
    ...
    @Test
    fun `updateBasicInfo should call dao with correct parameters`() = runTest {
        // Arrange
        coEvery { 
        ...
        // Act
        val result = repository.updateBasicInfo(
            draftId = "draft_123",
            amount = 5000000,
            tenor = 12,
            purpose = "Business",
    ...
    @Test
    fun `updateEmploymentInfo should call dao`() = runTest {
        // Arrange
        coEvery { 
        ...
        // Act
        val result = repository.updateEmploymentInfo(
            draftId = "draft_123",
            jobType = "Permanent",
    ...
    @Test
    fun `updateEmergencyContact should call dao`() = runTest {
        // Arrange
        coEvery { loanDraftDao.updateEmergencyContact(any(), any(), any(), any(), any(), any()) } just Runs

        // Act
        val result = repository.updateEmergencyContact(
            draftId = "draft_123",
    ...
    @Test
    fun `updateBankInfo should call dao`() = runTest {
        // Arrange
    ...
    @Test
    fun `updateDocumentPaths should call dao`() = runTest {
        // Arrange
        coEvery { loanDraftDao.updateDocumentPaths(any(), any(), any(), any()) } just Runs

        // Act
        val result = repository.updateDocumentPaths(
            draftId = "draft_123",
    ...
    @Test
    fun `deleteDraft should call dao`() = runTest {
        // Arrange
    ...
    @Test
    fun `deleteAllDrafts should call dao`() = runTest {
        // Arrange
    ...
    @Test
    fun `completeDraft should call dao`() = runTest {
        // Arrange
    ...
    private fun createLoanDraftEntity(id: String) = LoanDraftEntity(
        id = id,
        amount = 5000000,
        tenor = 12,
        purpose = "Business",
